...
const Header = () => {
    return (
        <div className='flex justify-between items-center'>
            <Link className='text-5xl font-bold' to="/">JobHunter</Link>
            ...
            <button  className='text-white text-2xl rounded bg-gradient-to-r from-cyan-600 to-purple-500 p-1'>Star Applying</button>
        </div>
    );
};
